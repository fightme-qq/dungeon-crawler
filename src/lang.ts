...
const STRINGS = {
  en: {
    ...
    leaderboardFloor: 'FLOOR',
    leaderboardMoney: 'MONEY',
    leaderboardHint: 'Wheel to scroll',
    leaderboardHiddenUser: 'Hidden User',
  ...
  ru: {
    ...
    leaderboardTitle: 'Лучшие забеги',
    leaderboardLoading: 'Загрузка лидерборда...',
    leaderboardEmpty: 'Записей пока нет',
    leaderboardUnavailable: 'Лидерборд недоступен',
    leaderboardRank: 'МЕСТО',
    leaderboardPlayer: 'ИГРОК',
    leaderboardFloor: 'ЭТАЖ',
    leaderboardMoney: 'ДЕНЬГИ',
    leaderboardHint: 'Колесо — прокрутка',
    leaderboardHiddenUser: 'Скрытый игрок',
